...
const COPY_SVG = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><rect x="8" y="8" width="13" height="13" rx="2" stroke="#3D3D63" stroke-width="1.5"/><path d="M16 8V5C16 3.89543 15.1046 3 14 3H5C3.89543 3 3 3.89543 3 5V14C3 15.1046 3.89543 16 5 16H8" stroke="#3D3D63" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`
    ...
    try {
      if (typeof ClipboardItem !== 'undefined') {
        await navigator.clipboard.write([new ClipboardItem({
          'text/html': new Blob([`<p>${htmlBody}</p>`], { type: 'text/html' }),
